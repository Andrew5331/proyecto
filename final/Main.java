...
public class Main {
    ...
    private static final HashMap<String, Juego> inventario = new HashMap<>();
    private static final HashMap<Integer, Venta> facturas = new HashMap<>();
    private static final ArrayList<Membresia> membresias = new ArrayList<>();
    ...
    public static void crearCliente() {
        ...
        if (clientes.containsKey(cedula)) {
            JOptionPane.showMessageDialog(null, "El cliente con esta cédula ya está registraado en el sistema.");
        } else {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "La edad no es válida. El cliente no ha sido registrado", "Advertencia", JOptionPane.WARNING_MESSAGE);
            }
            ...
            if (inventario.containsKey(juego)) {
                ...
                try {
                    ...
                    if (game.unidades >= cantidad && edad >= minEdad) {
                        ...
                        JOptionPane.showMessageDialog(null, "No hay unidades suficientes en el inventario. Existencias actuales: " + game.unidades);
                    }
                }catch (NumberFormatException e){
                    JOptionPane.showMessageDialog(null, "La cantidad indicada no corresponde a un número");
                }
            } else {
    ...
    public static void getFactura() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "El id debe ser un número entero, el dato ingresado no corresponde a un número entero");
        }
